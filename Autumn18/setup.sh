...
cd ${run}
mkdir tarball
#PATH# cp /nfs/dust/cms/user/zimmerc/ggh_production/Autumn18/template_2HDM/* ./tarball
...
tar czf ${run}.tar.gz *
#PATH# mv ${run}.tar.gz /nfs/dust/cms/user/zimmerc/ggh_production/Autumn18/CMSSW_10_2_3/src/
cd ..
