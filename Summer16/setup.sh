...
cd ${run}
mkdir tarball
#PATH# cp /nfs/dust/cms/user/zimmerc/ggh_production/Summer16/template_2HDM/* ./tarball
...
tar czf ${run}.tar.gz *
#PATH# mv ${run}.tar.gz /nfs/dust/cms/user/zimmerc/ggh_production/Summer16/CMSSW_7_1_32_patch1/src/
cd ..
